...
const HeroContent = () => {
  ...
  return (
    <div>
        ...
        Join the Kebbi Tech Hub to <AnimatedTitle textArray={textArray} cursorColor="white" typingSpeed={100} />
        </h1>
        {/* description  */}
        <p data-aos="fade-left" data-aos-delay="200" className='mt-12 text-sm md:text-base text-white text-opacity-60'>
        Kebbi Innovation & Technology Hub provides high-quality tech training through a blend of online and onsite programs to help you achieve your goals.
        </p>
        {/* button  */}
        <div className='mt-8 flex items-center space-x-4'>
            ...
            <button data-aos="zoom-in" data-aos-delay="450" className='button__cls bg-pink-700 hover:bg-pink-900'>Learn More</button>
        </div>
        {/* stats  */}
        <div className="flex items-center flex-wrap space-x-16 mt-8">
            ...
            <div data-aos="fade-up" data-aos-delay="900" >
                <p className='md:text-xl lg:text-2xl text-base text-white font-bold'>22+</p>
